    ...
    def get_definition(self) -> ToolDefinition:
        return ToolDefinition(
            ...
            description=(
                ...
                "read_learning_chart_data and copy its dataset_ref, source, unit, labels and datasets exactly; "
                "never invent or alter values. Use diagram for processes, structure, "
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        ...
        try:
            ...
            if payload.get("kind") == "chart":
                ...
                if not source_ref.startswith("dataset_") or not source_ref[8:].isalnum():
                    raise ValueError("请先用 read_learning_chart_data 获取可信 dataset_ref")
                source_path = profile_root / "artifacts" / "visualization_datasets" / f"{source_ref}.json"
                ...
                if supplied.get("labels") != expected.get("labels") or supplied.get("datasets") != expected.get("datasets"):
